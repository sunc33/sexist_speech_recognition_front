...
path_page = 'raw_data/df_page.csv'
...
path_post = 'raw_data/df_post.csv'
...
path_image = 'raw_data/Logo/ligne.png'
image = Image.open(path_image)
...
path_comments= 'raw_data/df_comments.csv'
...
## LOGO LE WAGON
path_wagon = 'raw_data/Logo/wagon-executive.jpg'
